...
</code></pre><h3 id="sagetech_mxs_usage" tabindex="-1">Usage <a class="header-anchor" href="#sagetech_mxs_usage" aria-label="Permalink to &quot;Usage {#sagetech_mxs_usage}&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>sagetech_mxs &lt;command&gt; [arguments...]</span></span>
...
<span class="line"><span></span></span>
<span class="line"><span>   squawk        Set the Squawk Code. [0-7777] Octal (no digit larger than 7)</span></span></code></pre></div>`,6)])])}const _=s(r,[["render",p]]);export{m as __pageData,_ as default};
